  ...
  return (
    <section id="services" className="border-b border-border py-24">
      <div ref={ref} className="container-editorial">
        <h2 className="mb-12 text-h2 font-display">Services</h2>
        <div className="flex flex-col">
          {services.map((service, i) => (
            ...
            >
              <h3 className="text-h3 font-display">{service.title}</h3>
              <div>
                <p className="mb-4 max-w-xl text-body text-foreground/80">{service.description}</p>
